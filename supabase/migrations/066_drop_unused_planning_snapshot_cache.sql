...
-- Deep cleanup: remove the v316/v317 Planning snapshot architecture.
--
-- Current /api/planning/candidates reads canonical planning data directly;
-- the snapshot cache is no longer read. Keeping its statement-level dirty
-- triggers only adds a write/version-bump on every mutation of core tables.
-- Historical migrations 058/059 remain untouched for migration integrity.
-- =====================================================================
...
drop table if exists public.planning_candidate_snapshot;
