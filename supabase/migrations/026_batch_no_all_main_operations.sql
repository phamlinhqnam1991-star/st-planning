-- =====================================================================
-- 026_batch_no_all_main_operations.sql
-- Enforce Batch Prefix for every confirmed Main Planning Operation.
-- New Batch format: XXX_DDMMM_NNN
...
-- Prefixes are deliberately configured by Standard Operation.
-- Chemical-line operations may share CHM and therefore share one daily sequence.
