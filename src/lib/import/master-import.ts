...
export async function importMasterXlsx(filePath:string,c:PoolClient,batchId:string){
 ...
 let partRows:unknown[][]=[],revRows:unknown[][]=[],finishRows:unknown[][]=[],reqRows:unknown[][]=[],routeRows:unknown[][]=[],snapshotRows:unknown[][]=[];
