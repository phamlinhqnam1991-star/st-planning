...
export default async function Page(){
 ...
 return <main className="erp-shell">
  <header className="erp-header"><div><h1>ST Planning</h1><p>Surface Treatment Planning System</p></div><div className="erp-env">IMPORT MASTER</div></header>
  <AppTabs active="import"/>
  <section className="erp-content erp-content-full">
   <div className="erp-page-head"><div><h2>Import Master</h2><p>Incremental Master Data synchronization</p></div></div>
