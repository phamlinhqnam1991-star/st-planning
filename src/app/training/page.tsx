...
export default async function Page({searchParams}:{searchParams:Promise<{job?:string}>}){
 ...
 return <main className="erp-shell erpkit-migrated-page">
  ...
  <section className="erp-content erp-content-full guide-page training-page">
   <div className="erp-page-head guide-head"><div><div className="erp-object-eyebrow">ONBOARDING · LIVE DATABASE · ST PLANNING · V493</div><h2>New User Training — học bằng dữ liệu thật đang chạy</h2><p>Lý thuyết trước, sau đó đối chiếu ngay Operation Code, Main, Area, Planner, Recipe, Batch Rules, Process Time và một Job thật từ database. V493 giữ classifier READY/WAIT và Planning Board Quick View từ Scheduling Workload: click card để xem đúng Job theo Main/Recipe/Bucket; popup có Next Main + Next Recipe No/Name và nút lọc riêng trên từng cột. Có thể kết hợp nhiều filter; check-all chỉ chọn các Job đang hiển thị sau lọc. READY được tạo/thêm Batch bằng canonical Batch API, WAIT/HOLD chỉ xem.</p></div><div className="erp-command-actions"><Link className="btn" href="/logic-guide">Logic & Hướng dẫn</Link><Link className="btn primary" href="/job-tracker">Mở Job Tracker</Link></div></div>
