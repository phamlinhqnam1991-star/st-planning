// V496 Training sync: Dashboard removes KPI cards and mirrors Planning Board workload order/tone; Scheduling READY recipe rows show Previous Main Recipe breakdown while MAIN TOTAL remains compact.
...
export default async function Page({searchParams}:{searchParams:Promise<{job?:string}>}){
 ...
 return <main className="erp-shell erpkit-migrated-page">
  ...
  <section className="erp-content erp-content-full guide-page training-page">
   <div className="erp-page-head guide-head"><div><div className="erp-object-eyebrow">ONBOARDING · LIVE DATABASE · ST PLANNING · V496</div><h2>New User Training — học bằng dữ liệu thật đang chạy</h2><p>Lý thuyết trước, sau đó đối chiếu ngay Operation Code, Main, Area, Planner, Recipe, Batch Rules, Process Time và một Job thật từ database. V496 giữ toàn bộ classifier READY/WAIT, Planning Board Quick View và Internal Chat. Dashboard bỏ KPI card để tập trung vào bảng workload; bảng Dashboard dùng cùng thứ tự/màu bucket như Planning Board. Trên Scheduling, hai cột READY ở từng Recipe row hiển thị breakdown Recipe của Previous Main; MAIN TOTAL không breakdown. Các Alert/Audit và Batch/Schedule engine cũ vẫn giữ nguyên.</p></div><div className="erp-command-actions"><Link className="btn" href="/logic-guide">Logic & Hướng dẫn</Link><Link className="btn primary" href="/job-tracker">Mở Job Tracker</Link></div></div>
