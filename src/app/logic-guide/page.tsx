  ...
  <section className="erp-content erp-content-full guide-page">
   ...
   <Section id="production" title="11 · Production Execution — production worklist & completion reporting"
    ...
    <div className="lg-key lg-key-2">
     ...
     <Rule title="Production Day · V445" tone="important">Production Execution dùng đúng ngày sản xuất 06:00 ngày D → trước 06:00 ngày D+1 theo planned_start của Main Schedule. Ví dụ 00:30 ngày 03/09 vẫn nằm trong báo cáo ngày 02/09. End có thể kéo qua 06:00 nhưng ownership của ngày không đổi.</Rule>
