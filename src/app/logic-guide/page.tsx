// V510 Internal Chat: stable fail-open page, immediate PostgreSQL realtime SYSTEM notifications, unread badges, and direct user chat. V509 Global Realtime No-Supabase remains the transport.
