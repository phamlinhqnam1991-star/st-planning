  ...
  <section className="erp-content erp-content-full guide-page">
   ...
   <Section id="schedule" title="9 · Tab Board Điều Độ — xếp Batch vào resource và thời gian"
    ...
    <Rule title="Trial · Dời toàn bộ ngày điều độ" tone="important">
     Nút <b>Dời toàn bộ lịch → +1 ngày</b> trên Board Điều Độ dùng để tiếp tục một ngày test sang ngày kế tiếp. Từ V444, “một ngày” ở đây là <b>ngày sản xuất 06:00 → 06:00 hôm sau</b>, đồng nhất với Production Timeline, không phải ngày lịch 00:00 → 24:00. Vì vậy lô bắt đầu lúc <b>00:00–05:59 của ngày kế tiếp</b> vẫn thuộc ngày sản xuất nguồn và được MOVE cùng toàn bộ ngày, không còn bị hiểu nhầm là lịch độc lập của ngày đích. Hệ thống <b>MOVE in-place</b>, không clone Batch/Schedule; <code>schedule_date</code> được tính lại từ <code>planned_start</code> sau khi dịch. Resource, Recipe, Duration, Sequence và toàn bộ timestamp Chemical Line <b>Loading / Process / NDT / Unloading</b> dịch cùng đúng ±1 ngày. Sau commit ngày sản xuất nguồn phải rỗng. Nếu ngày sản xuất đích thực sự có lịch độc lập, có RUNNING/COMPLETED hoặc có lịch khác chạy xuyên khoảng đích thì rollback toàn bộ. Planning Chain/Candidate/Batch membership/Recipe không thay đổi.
    </Rule>
