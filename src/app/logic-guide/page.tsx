// V524 ST Output: INTERMEDIATE_NO_CHAIN is built from audit first, then filtered again to active ST Planning NextOperation with Source -> Main Mapping.
  ...
  <section className="erp-content erp-content-full guide-page">
   ...
   <Section id="st-output" title="6.5 · Tab ST Output — Output ST dm²/ngày theo kế hoạch"
    ...
    <StepList items={[
     ...
     <><code>INTERMEDIATE_NO_CHAIN</code> phải qua 2 bước: trước hết ra danh sách audit Intermediate/Bridge chưa resolve current Planning Board row, sau đó chỉ giữ Job có <code>NextOperation</code> là <b>ST Planning Operation</b> và có active <b>Source → Main Mapping</b>.</>,
