// V526 ST Output: restore the V523 calculation for INTERMEDIATE_NO_CHAIN.
  ...
  <section className="erp-content erp-content-full guide-page">
   ...
   <Section id="st-output" title="6.5 · Tab ST Output — Output ST dm²/ngày theo kế hoạch"
    ...
    <StepList items={[
     ...
     <><code>INTERMEDIATE_NO_CHAIN</code> dùng lại logic V523: Intermediate/Bridge thuộc ST chưa resolve Planning Chain, và <code>NextOperation</code> phải thuộc <b>ST Output scope V523</b> (<code>st_ops</code>). Không ép RAW operation phải là Planning Operation hoặc phải có Source → Main Mapping.</>,
