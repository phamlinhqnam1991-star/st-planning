// V525 ST Output: INTERMEDIATE_NO_CHAIN is built from Audit All Open Job first, then filtered again by active explicit ST Scope membership.
  ...
  <section className="erp-content erp-content-full guide-page">
   ...
   <Section id="st-output" title="6.5 · Tab ST Output — Output ST dm²/ngày theo kế hoạch"
    ...
    <StepList items={[
     ...
     <><code>INTERMEDIATE_NO_CHAIN</code> phải qua 2 bước: trước hết ra danh sách audit Intermediate/Bridge chưa resolve current Planning Board row, sau đó chỉ giữ Job có <code>NextOperation</code> là <b>Operation thuộc active ST Scope</b>.</>,
