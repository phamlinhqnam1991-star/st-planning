  ...
  <section className="erp-content erp-content-full guide-page">
   ...
   <Section id="production" title="11 · Production Execution — production worklist & completion reporting"
    ...
    <div className="lg-key lg-key-2">
     ...
     <Rule title="Production Day · V445/V446" tone="important">Production Execution hiển thị toàn bộ kế hoạch có planned_start từ 06:00 ngày D đến trước 06:00 ngày D+1 (tức 05:59 cuối ngày sản xuất). Ví dụ 00:30 ngày 03/09 vẫn nằm trong báo cáo ngày 02/09. End có thể kéo qua 06:00 nhưng ownership không đổi. V446 date navigation remount dữ liệu theo ngày mới ngay khi bấm Trước/Tiếp/Hôm nay, không cần F5.</Rule>
     <Rule title="Job-level reporting · V446" tone="important">Mỗi Job trong Batch/Masking/Unmasking có trạng thái riêng WAITING → ON-GOING → DONE. ON-GOING ghi Actual Start của Job; DONE ghi Actual End. Dòng Batch/Main phía trên chỉ là summary tương thích, không còn là nơi nhập trạng thái.</Rule>
     ...
     <Rule title="All Job rows + no inner vertical scroll · V446">Masking/Unmasking vẫn group theo Batch/Main để giữ worklist thực tế, nhưng mọi khu vực kể cả Chemical Line/Painting đều mở đầy đủ Job detail. Các bảng không giới hạn max-height/inner vertical scrollbar; cuộn dọc dùng trang chính, horizontal scroll vẫn giữ khi cần.</Rule>
