...
export default async function Page(){
 ...
 try{
  ...
  const [mainOperations,groups,areas,scheduleAreas]=await Promise.all([
  ...
  /><UnconfiguredOperationsManager rows={rows} mainOperations={mainOperations as any} groups={groups as any} areas={areas as any} scheduleAreas={scheduleAreas as any} reviewTableReady={reviewTableReady}/></section></div></main>;
 }catch(e){
