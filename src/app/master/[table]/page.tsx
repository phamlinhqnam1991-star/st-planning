...
const masterTabs=[
 {key:"part",label:"Part",href:"/master/part",group:"Sản phẩm"},{key:"revision",label:"Part Revision",href:"/master/revision",group:"Sản phẩm"},
 {key:"finish",label:"Material Finish",href:"/master/finish",group:"Sản phẩm"},{key:"requirement",label:"Process Requirement",href:"/master/requirement",group:"Sản phẩm"},
 {key:"sourceoperation",label:"Source Operation",href:"/master/sourceoperation",group:"Operation & Routing"},{key:"routing",label:"Routing Detail",href:"/master/routing",group:"Operation & Routing"},
 {key:"strouting",label:"ST Routing Master",href:"/master/strouting",group:"ST Model"},{key:"stroutingchain",label:"ST Routing Chain",href:"/master/stroutingchain",group:"ST Model"},
