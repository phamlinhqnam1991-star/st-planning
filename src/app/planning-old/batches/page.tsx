  ...
  return <main className="erp-shell">
   ...
   <section className="erp-content erp-content-full planning-page planning-batches-page">
    <div className="erp-page-head">
     <div>
      <h2>Planning Batches · Baseline cũ</h2>
      <p>Bản giao diện cũ giữ nguyên để đối chiếu trong giai đoạn chuyển ERP.</p>
     </div>
    </div>

    <PlanningViewTabs active="batches" basePath="/planning-old"/>
        ...
        {batchesQ.rows.map((b:any)=><tr key={b.id}>
         ...
         <td>
          <div className="batch-list-actions">
           <Link className="erp-link" href={`/planning-old/batches/${b.id}`}>View →</Link>
           <BatchRowActions
            batchId={Number(b.id)}
            batchNo={b.batch_no||"—"}
